    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
       <Link href="/" className="text-[#1E88E5] font-bold text-xl block mb-8">HnAlink</Link>
        ...
        <p className="text-gray-500 mb-8">Log in to send booking requests to hosts.</p>
        ...
        <p className="text-center mt-4">
          <Link href="/forgot-password" className="text-[#1E88E5] hover:underline text-sm">Forgot password?</Link>
        </p>
        <p className="text-gray-500 text-sm mt-6 text-center">
          Don&apos;t have an account?{" "}
          <Link href="/signup/student" className="text-[#1E88E5] hover:underline">Sign up</Link>
        </p>
      </div>
    </main>
  );
